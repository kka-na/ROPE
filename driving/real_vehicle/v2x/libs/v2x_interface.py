...
class eNrV2xCmd(Enum):
    ...
    CMD_SEND_TEST_EXTENSIBLE_V2_V2V = 9
    CMD_SEND_TEST_EXTENSIBLE_V2_V2I = 10
    CMD_SEND_TEST_EXTENSIBLE_V2_V2V_ADD_SEQUENCE = 11
    CMD_SEND_TEST_EXTENSIBLE_V2_V2I_ADD_SEQUENC = 12
    CMD_SEND_TEST_FTP_CONN_INFO_RESP = 13
    CMD_MAX = 14
